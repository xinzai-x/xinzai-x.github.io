...
img:
coverImg:
cover: https://s2.loli.net/2025/12/28/7n3aftbClOu4ATy.webp
password:
categories: 技术积累
tags: 博客搭建相关
---
...
<img src="https://s2.loli.net/2025/12/28/3t1GcLi4xDMK2jJ.png" style="zoom:50%;" />

在项目中的_config.yml网址需要用这个，否则可能上传时卡顿导致错误

<img src="https://s2.loli.net/2025/12/28/FATHSvhQIaNCO87.png" style="zoom:50%;" />
...
![](https://s2.loli.net/2025/12/28/NAebDLwaR9Y4MIP.webp)
...
<img src="https://s2.loli.net/2025/12/28/n3bVBKP7AdsLqWm.webp" style="zoom:50%;" />

创建之后，可以回到首页可以看到我们三个API值（等等需要用）

<img src="https://s2.loli.net/2025/12/28/9Sm5hNj64lnkgLt.webp" style="zoom:50%;" />
...
<img src="https://s2.loli.net/2025/12/28/dHqJosCV65tX13S.webp"  />
...
![](https://s2.loli.net/2025/12/28/zw6SiLVAh7uZ9eJ.webp)
...
<img src="https://s2.loli.net/2025/12/28/2yEsmhgOXA4ducW.png" style="zoom:67%;" />
...
<img src="https://s2.loli.net/2025/12/28/O8bKhLoPmG7WMHy.png" style="zoom: 67%;" />

进入登录GitHub，在设置中添加ssh key

![](https://s2.loli.net/2025/12/28/QlwyiAHFGfTqj2X.png)

将上一步中的文件里面的内容全部复制进去 ，点击添加

![](https://s2.loli.net/2025/12/28/LPyxSe4M1q78Zgh.png)
...
<img src="https://s2.loli.net/2025/12/28/pJ9Q2RwECeW6sdF.png" style="zoom:50%;" />
...
<img src="https://s2.loli.net/2025/12/28/R26UpPGnulA4qYo.png" style="zoom:67%;" />

填写好图片信息，创建即可

![](https://s2.loli.net/2025/12/28/poks2fvbnPIAE5X.png)

## 生成Token令牌

点击头像，点击`Settings`，滑到最后，点击图中圈出的

<img src="https://s2.loli.net/2025/12/28/IvkCGlNWt9aBXfi.png" style="zoom:50%;" />

![](https://s2.loli.net/2025/12/28/lZnziVEJfkyrS2R.png)

按图中顺序依次进入

![](https://s2.loli.net/2025/12/28/pvlfMbUeAHP5m43.png)

过期时间：`No expiration`(永久不过期)

![](https://s2.loli.net/2025/12/28/WGIDt2Hx8c9z5hw.png)

> **务必将令牌保存起来**，放在一个安全的地方，页面关掉后就看不到了

![](https://s2.loli.net/2025/12/28/BboFk5Vj9gZcEUw.png)

## 创建img文件夹

回到刚才新建存放图片的仓库，新建文件夹

<img src="https://s2.loli.net/2025/12/28/pwM7fCIPdD6zSKX.png" style="zoom:50%;" />

给文件夹命名

![](https://s2.loli.net/2025/12/28/pBWDEVlaeYgRZvk.png)
...
<img src="https://s2.loli.net/2025/12/28/Cp8AgUucetl5fnQ.png" style="zoom:50%;" />

点击上传区上传图片，上传成功之后

<img src="https://s2.loli.net/2025/12/28/BSi7hw9YFGnJ6K5.png" style="zoom:50%;" />

如果提示网络不好等错误，可能不稳定，稍后再试试看。或者可以重启试试看!！

在Typora中，文件-》偏好设置中，设置成下图，将语法偏好所有选项关闭，可以避免直接复制图片进Typora报错

<img src="https://s2.loli.net/2025/12/28/zsUK7f8IDFtnwL6.png" style="zoom:50%;" />

仓库可能最多只能存放1g，网上说的，所以最好快到的时候重新建一个仓库

差不多到达1g，重新建一个仓库，建仓库上述有说，但新仓库不能与旧仓库同名，可在后面加1，创建完成后，其他无需设置，在PicGo设置一下新仓库名，和自定义域名后面的仓库名

<img src="https://s2.loli.net/2025/12/28/SmgCs26Pb8UpRuH.png" style="zoom:50%;" />
